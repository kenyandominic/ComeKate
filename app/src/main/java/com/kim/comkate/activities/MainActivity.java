...
import com.kim.comkate.Adapters.RecentConversationAdapter;
import com.kim.comkate.R;
import com.kim.comkate.databinding.ActivityMainBinding;
            ...
            for (DocumentChange documentChange : value.getDocumentChanges()){
                if (documentChange.getType() == DocumentChange.Type.ADDED){
                    ...
                    for (int i = 0 ; i < conversations.size(); i++){
                        ...
                        if (
                                conversations.get(i).senderId.equals(senderId) && conversations.get(i).receiveId.equals(receiverId)
                        ){
