...
import com.kim.comkate.Adapters.ChatAdapter;
import com.kim.comkate.databinding.ActivityChatBinding;
import com.kim.comkate.model.ChatMessage;
import com.kim.comkate.model.User;
import com.kim.comkate.network.ApiClient;
import com.kim.comkate.network.ApiService;
...
public class ChatActivity extends BaseActivity {
        ...
        ApiClient.getClient().create(ApiService.class).sendMessage(
            ...
            public void onResponse(@NonNull Call<String> call,@NonNull Response<String> response) {
             if (response.isSuccessful()){
                 ...
                 showToast("Notification sent successffully");
    ...
    private void addConVresion(HashMap<String, Object> conversion){
